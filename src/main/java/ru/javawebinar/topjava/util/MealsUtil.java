...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            new Meal(1, LocalDateTime.of(2015, Month.MAY, 1, 10, 0), "Завтрак", 500),
            new Meal(2, LocalDateTime.of(2015, Month.MAY, 23, 13, 0), "Обед", 1000),
            ...
            new Meal(2, LocalDateTime.of(2015, Month.MAY, 8, 13, 0), "Обед", 500),
            new Meal(3, LocalDateTime.of(2015, Month.MAY, 9, 20, 0), "Ужин", 510)
    );
