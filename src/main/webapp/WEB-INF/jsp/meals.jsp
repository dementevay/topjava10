...
<section>
    ...
    <hr>
    <a href="meals?action=create"><spring:message code="meals.addMeal"/></a>
    <hr>
    <table border="1" cellpadding="8" cellspacing="0">
        <thead>
        <tr>
            <th><spring:message code="meals.date"/></th><%--Date--%>
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr class="${meal.exceed ? 'exceeded' : 'normal'}">
                ...
                <td>${meal.calories}</td>
                <td><a href="meals?action=update&id=${meal.id}"><spring:message code="meals.update"/></a></td>
                <td><a href="meals?action=delete&id=${meal.id}"><spring:message code="meals.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
